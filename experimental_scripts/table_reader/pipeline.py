...
#
doc_parser = DocParser(fs) #02460543_dormant_bs 04391694_active_bs SC564642_bs astra_zeneca_bs 03541703_bs   03875584_bs  (04416996_bs date error due to alignment) 01933071_bs (no assets)
doc_parser.parse_document("ons-companies-house-dev-scraped-pdf-data/doc_ai_outputs/bs_pdfs/04416996_bs.pdf",
